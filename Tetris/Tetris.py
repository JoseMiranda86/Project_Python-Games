...
def draw_next_shape(shape, surface):
    ...
    sx = top_left_x + playing_area_width + 50
    sy = top_left_y + playing_area_height/2 - 100
    format = shape.shape[shape.rotation % len(shape.shape)]
...
def draw_window(surface):
    ...
    surface.blit(label, (top_left_x + playing_area_width / 2 - (label.get_width() / 2), 30))
    ...
    pygame.draw.rect(surface, (255, 0, 0), (top_left_x, top_left_y, playing_area_width, playing_area_height), 5)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_SPACE:
                   while empty_space(current_piece, grid):
                       current_piece.y += 1
                   current_piece.y -= 1
